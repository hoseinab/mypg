...
<head>
    ...
    <title>LaraCMS</title>
    <link href="/css/m/lib/bootstrap/bootstrap-rtl.min.css" rel="stylesheet">
    <link href="/css/m/helper.css" rel="stylesheet">
    <link href="/css/m/fonts.css" rel="stylesheet">
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                 ...
                 <li><a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-book"></i><span
                    ...
                    <li><a class="has-arrow  " href="{{ route('admin.categories') }}" aria-expanded="false"><i class="fa fa-tags"></i><span
...
<script src="/js/m/lib/jquery/jquery.min.js"></script>
<!-- Bootstrap tether Core JavaScript -->
<script src="/js/m/lib/bootstrap/js/popper.min.js"></script>
<script src="/js/m/lib/bootstrap/js/bootstrap.min.js"></script>
<!-- slimscrollbar scrollbar JavaScript -->
<script src="/js/m/jquery.slimscroll.js"></script>
<!--Menu sidebar -->
<script src="/js/m/sidebarmenu.js"></script>
<!--stickey kit -->
<script src="/js/m/lib/sticky-kit-master/dist/sticky-kit.min.js"></script>
<script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
<!--Custom JavaScript -->
<script src="/js/m/custom.min.js"></script>
<script src="/js/m/cms.js"></script>
</body>
</html>